...
-- Hitung tinggi frame sesuai jumlah tombol
local buttonCount = 0
for _ in pairs(checkpoints) do
    buttonCount = buttonCount + 1
end
local frameHeight = buttonCount * 50 + 10 -- 50 per tombol + padding

-- Frame untuk menu teleport
local menuFrame = Instance.new("Frame")
menuFrame.Size = UDim2.new(0, 200, 0, frameHeight)
...
-- tombol toggle (dragable, melengkung, outline putih)
